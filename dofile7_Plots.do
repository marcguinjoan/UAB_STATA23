...
**********************************************************************
************ 7) Coefficient plots and interaction effects ************
**********************************************************************
...
***Now, we will continue working with the Ukranian sample of the 2020 World Values Survey, but we will compare it with the Russian sample, also from 2020. So, first, we will need to "add" the Russian sample (2017) to the Ukranian one
...
append using "databases\WVS\WVS_Wave_7_Russian_Federation_Stata_v2.0.dta"
