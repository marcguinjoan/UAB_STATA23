...
import spss using "https://upceo.ceo.gencat.cat/wsceop/8508/Microdades%20anonimitzades%201035.sav", clear

recode SEXE (1=0 "Man") (2=1 "Female"), gen(female)
label variable female "Gender"

recode IDEOL_0_10 (98/99=.), gen(ideology)
...
recode LLOC_NAIX (1=1 "Catalonia") (2=2 "Other regions from Spain") (5=3 "Rest of the world"), gen(born)
...
recode REC_PARLAMENT_VOT (3=1 "ERC") (21=2 "Junts") (4=3 "PSC") (18=4 "En Comú Podem") (10=5 "CUP") (1=6 "PP") (23=7 "Vox") (6=8 "C's") (98/99=.) (else=9 "Other options"), gen(party)
