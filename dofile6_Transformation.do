...
********************************************************************************
************ 6) Transformation of variables and logistic regression ************
********************************************************************************
...
***Now we will work with the Ukranian sample of the 2020 World Values Survey. We will practice the creation of new complex variables (indexes) and the mathematical transformation of existent variables. Also, we will jump into logistic regression for binary dependent variables and the plotting of results. 

use "databases\WVS\WVS_Wave_7_Ukraine_Stata_v2.0.dta", clear
